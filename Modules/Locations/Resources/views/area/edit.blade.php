                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8" id="">
                            <input type="text" name="name" class="form-control" id="name" placeholder="Thana Name" value="{{ $area->name }}" required>
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8" id="">
                            <input type="text" name="bn_name" class="form-control" id="bn_name" placeholder="Thana Name(Bangla)" value="{{ $area->bn_name }}" required>
                        ...
                        <div class="col-sm-8  ">
                            <select class="form-control" name="thana_id" required>
                                ...
                                @if($thanas->isNotEmpty())
                                    ...
                                    <option value="{{ $item->id }}" @if($item->id == $area->thana_id) selected @endif >{{ $item->name }}</option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8  ">
                            <select class="form-control" name="status" required>
                                <option value="1" @if($area->status == 1) selected @endif >Yes</option>
                                <option value="0" @if($area->status == 0) selected @endif>No</option>
                            </select>
