...
//                        $order->subidha_comission = $order->subidha_comission - $order->point_amount;
    ...
    {
        return Order::with(['cancelReason', 'orderItems.product', 'orderItems.product.company', 'orderItems.product.generic', 'address.area.thana.district', 'pharmacy.pharmacyBusiness', 'customer'])
            ->where('id', $id)
            ->first();
