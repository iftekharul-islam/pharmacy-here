    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <a href="{{ route('form.create') }}" class="btn btn-lg btn-success float-right">
                        Create Product From
                    </a>
                </div>
            </div>
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Product Form List</h3>
        </div>
        <!-- /.card-header -->
                ...
                @foreach($formList as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('form.edit', $item['id']) }}" class="btn btn-sm btn-primary">
                                <i class="fa fa-edit"></i> </a>
                            <form id="delete-form-{{ $loop->index }}" action="{{ route('form.destroy', $item['id']) }}"
                                  method="post"
